-- Keep application sessions valid until the user explicitly logs out.
-- Existing sessions that have not expired yet are upgraded to persistent.
...
BEGIN
  ...
  WHERE app_sessions.user_id = v_user.id;
